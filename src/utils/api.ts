...
export const productsApi = {
  ...
  createProduct: (product: any) => apiClient.post<ApiResponse>('/products', product),

  updateProduct: (productId: string, product: any) =>
    apiClient.put<ApiResponse>(`/products/${productId}`, product),

  deleteProduct: (productId: string) =>
    apiClient.delete<ApiResponse>(`/products/${productId}`),

  updateProductStock: (productId: string, quantity: number) =>
    apiClient.put<ApiResponse>(`/products/${productId}`, { stock_quantity: quantity }),
};
